...
<acme:list>
	<acme:list-column code="fundraiser.tactic.list.label.name" path="name" width="80%"/>	
	<acme:list-column code="fundraiser.tactic.list.label.notes" path="notes" width="20%"/>
