...
<acme:list>
	...
	<acme:list-column code="auditor.audit-report.list.label.description" path="description" width="20%"/>
	<acme:list-column code="auditor.audit-report.list.label.moreInfo" path="moreInfo" width="20%"/>
</acme:list>
