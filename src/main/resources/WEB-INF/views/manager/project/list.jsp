...
<acme:list>
	...
	<acme:list-column code="manager.project.list.label.description" path="description" width="20%"/>
	<acme:list-column code="manager.project.list.label.keyWords" path="keyWords" width="20%"/>
