...
<acme:list>
	...
	<acme:list-column code="any.project.list.label.description" path="description" width="20%"/>
	<acme:list-column code="any.project.list.label.keyWords" path="description" width="20%"/>
